...
<head>
  ...
  <title>Gestión de Editoriales - Biblioteca Virtual HZG</title>
...
<body>
  ...
  $(document).ready(function() {
                  ...
                  <tr class="editorial-slide-in">
                      ...
                      <td class="text-end">
                          <div class="editorial-btn-group" role="group">
                              <button type="button" class="editorial-btn editorial-btn-info editorial-tooltip" onclick="verDetalles(${editorial.ideditorial})" data-tooltip="Ver detalles">
                                  <i class="ti ti-eye"></i>
                              </button>
      ...
      function verDetalles(id) {
          window.location.href = `<?= base_url('editoriales/detalles') ?>/${id}`;
      }
